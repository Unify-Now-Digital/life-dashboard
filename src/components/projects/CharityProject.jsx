...
export default function CharityProject({ state, meta, onClose, goalHandlers }) {
  const data = state.projects.charity;
  return (
    <Project title="Charity" color={meta.color} onClose={onClose} goals={data.goals} goalHandlers={goalHandlers}>
